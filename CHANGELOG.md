...
- Added repository exclusions for model binaries, licenses, article archives, runtime files, and temporary outputs.

## 1.1.0

- Added common-scale potential and stress figures.
- Added a zero-baseline 100 MPa potential comparison.
- Added the 0-100 MPa pressure sweep and linear response coefficients.
- Added an independent-scale potential comparison for spatial-pattern inspection.
